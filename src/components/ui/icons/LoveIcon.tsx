...
interface LoveIconProps extends IconProps {}

export default function LoveIcon({ width, height }: LoveIconProps) {
  return (
    <svg
      width="32"
      height="32"
    ...
    >
      <rect width="32" height="32" rx="2" fill="url(#paint0_linear_149_3170)" />
      <path
