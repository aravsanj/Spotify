...
export default function Sidebar() {
  return (
    <div className="relative z-20 flex min-h-screen w-[100px] flex-col gap-y-14 bg-black pt-10 transition-all duration-500 ease-in-out sm:items-start lg:w-[310px] lg:px-6">
